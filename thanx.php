...
?>
			...
			<tbody id="2" style="display: none;">
					...
					<p><center>
					  <p>
					    <input type="image" src="login.gif" alt="Click Hear For Login..!!" name="submit" width="120" height="100" />
				      </p>
					  <p class="style2">Thanks For Your Valuable Feedback</p>
					  <p class="style5"><blink>Have a nice day !</blink>  </p>
					</center>
					<br />
					  </p>
					</form>
...
<div id="footer">
	<p>Copyright © 2010 RCPIT,Shirpur. Designed by<strong> <span class="style4"><a href="http://www.ameyjadiye.co.nr/" target="_blank" onmouseover="Tip('<a href=\'mailto:ameyjadiye@gmail.com\'>ameyjadiye@gmail.com</a>')" onmouseout="UnTip()">Amey Jadiye </a></span> &amp; <span class="style4"><a href="mailto:saurabh.princesam@gmail.com" target="_blank">Saurabh Agarwal </a></span> </strong></p>
