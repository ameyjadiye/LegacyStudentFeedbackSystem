<?php
/*suppose 1a-14c values are taken from the database */
$dbhost = 'localhost';
$dbuser = 'aj';
$dbpass = 'aj';
...
$out14=($a14a['14a']+$a14b['14b']+$a14c['14c'])*6; 
$tot14=$a14as+$a14bs+$a14cs;
$p14=($tot14*100)/$out14;
...
echo'</th><th>SrNo.</th><th>Qno.</th><th>A Nos.</th><th>A Multiplied BY</th><th>A Sub. Total</th><th>Nos</th><th>Multiplied By</th><th>Sub Total</th><th>Nos.</th><th>Multiplied By.</th><th>Sub Total</th><th>Nos.</th><th>Multiplied By</th><th>Sub Total</th><th>Out Of</th><th>Total</th><th>%</th>';
...
echo '<tr><td>13</td><td>13</td><td>'.$a13a['13a'].'</td><td>6</td><td>'.$a13as.'</td><td>'.$a13b['13b'].'</td><td>3</td><td>'.$a13bs.'</td><td>'.$a13c['13c'].'</td><td>1</td><td>'.$a13cs.'</td><td></td><td></td><td></td><td>'.$out13.'</td><td>'.$tot13.'</td><td>'.$p13.'</td></tr>';
echo '<tr><td>14</td><td>14</td><td>'.$a14a['14a'].'</td><td>6</td><td>'.$a14as.'</td><td>'.$a14b['14b'].'</td><td>3</td><td>'.$a14bs.'</td><td>'.$a14c['14c'].'</td><td>1</td><td>'.$a14cs.'</td><td></td><td></td><td></td><td>'.$out14.'</td><td>'.$tot14.'</td><td>'.$p14.'</td></tr>';
...
if ($per10>8)
echo "<h4> the grade of the teacher is excellent</h4>";
if ($per10>6 && $per10<8)
echo "<h4> the grade of the teacher is good</h4>";
if ($per10>4 && $per10<6)
echo "<h4> the grade of the teacher is satisfactory</h4>";
if($per10>2 && $per10<4)
echo "<h4> the grade of the teacher is un satisfactory</h4>";
if ($per10<2)
echo "<h4> the grade of the teacher is poor</h4>";
//table 2
